        ...
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <article className="mb-12 flex flex-col sm:flex-row bg-white rounded-lg overflow-hidden
                ...
                <div className="sm:basis-1/3 overflow-hidden">
                    <img
                        alt="Pet Care"
                        src="https://images.unsplash.com/photo-1609557927087-f9cf8e88de18"
                    ...
                    <SwiperSlide key={item._id}>
                        <div className="relative overflow-hidden rounded-lg shadow-md 
                            ...
                            <div className="absolute bottom-0 left-0 right-0 
                                bg-gradient-to-t from-black to-transparent p-4
                                transition-all duration-500 
                                group-hover:bg-[#F6F0E2] group-hover:bg-opacity-90">
                                <h3 className="text-lg font-semibold text-[#F6F0E2] 
                                    transition-all duration-500 
                                    group-hover:text-[#FFD700]">
                                    {item.servicesName}
                                </h3>
                                <Link to={`/Detailservice/${item._id}`}>
                                    <span className="mt-2 inline-block bg-black px-6 py-3 
