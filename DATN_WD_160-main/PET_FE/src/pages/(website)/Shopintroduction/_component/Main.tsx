...
import { FaPaw, FaHeart, FaMedal, FaUserMd, FaCut, FaUtensils, FaFacebookF, FaTwitter, FaLinkedinIn, FaEnvelope, FaPhoneAlt, FaCalendarCheck, FaCertificate, FaUserPlus } from "react-icons/fa";
