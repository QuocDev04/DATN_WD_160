...
import Page from "@/pages/(website)/home/_component/Page";
import Magazine from "@/pages/(website)/petmagazine/pages";
...
import MagazineDetail from "@/pages/(website)/petmagazine/detail";
        ...
        <>
            <Routes>
                ...
                <Route path="/" element={<Layout />}>
                    ...
                    <Route path="/petmagazine" element={<Magazine />} />
